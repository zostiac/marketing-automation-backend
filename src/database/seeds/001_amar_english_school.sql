...
INSERT INTO schools (
  ...
  '{"tone":"professional, premium, modern and school-appropriate","imagery":"occasion-appropriate custom illustrations, students, school environment and relevant cultural/educational visuals","composition":"dynamic, strong visual hierarchy, balanced whitespace, asymmetrical where appropriate","visual_reference":"Awwwards","avoid":"generic AI style, clipart, excessive 3D, photorealism"}'::jsonb,
